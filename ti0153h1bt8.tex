...
Study conducted by~\citet{Schmauser1999} suggested that the degree of DPP4 sialylation contributes to different isoelectric points (IP) and was responsible for extraordinary migration behavior under sulfate-polyacrylamide gel electrophoresis (SDS-PAGE)~\textit{in vitro}.