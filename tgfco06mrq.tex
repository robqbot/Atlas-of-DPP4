...
DPP4 expression on resting T cells is scarce, mostly observed with CD4\textsuperscript{+} T helper cells, CD8\textsuperscript{+} T\textsubscript{c} cells~\cite{Gorrell1991} and CD45RO\textsuperscript{+} memory T cells. DPP4 expression has
