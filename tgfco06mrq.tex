...
DPP4 expression on resting T cells is scarce and tightly regulated, mostly observed DPP4 expression on resting T cell population  CD4\textsuperscript{+} T memory helper cells~\cite{Gorrell1991, Morimoto1998} and  DPP4 expression is significantly up-regulated on activation. 
