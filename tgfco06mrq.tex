...
DPP4 expression on resting T cells is scarce, mostly observed with CD4\textsuperscript{+} T helper cells, CD8\textsuperscript{+} T\textsubscript{c} cells and CD45RO\textsuperscript{+} memory T cells
